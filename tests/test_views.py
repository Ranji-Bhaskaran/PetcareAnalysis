...
def test_pet_list_view(client, django_user_model):
    ...
    pet = Pet.objects.create(owner=django_user_model.objects.first(), name="Buddy", breed="Labrador", age=5, weight=25.0)
...
def test_edit_pet_view(client, django_user_model):
    ...
    pet = Pet.objects.create(owner=django_user_model.objects.create_user(username='testuser', password='password'),
                             name="Buddy", breed="Labrador", age=5, weight=25.0)
    client.login(username='testuser', password='password')
