...
TWILIO_PHONE_NUMBER = config('TWILIO_PHONE_NUMBER', default=os.environ.get('TWILIO_PHONE_NUMBER'))
ADMIN_PHONE_NUMBER = config('ADMIN_PHONE_NUMBER', default=os.environ.get('ADMIN_PHONE_NUMBER'))

TELEGRAM_BOT_TOKEN = config('TELEGRAM_BOT_TOKEN', default=os.environ.get('TELEGRAM_BOT_TOKEN'))
